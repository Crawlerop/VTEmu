 ...
 *
 * $URL: svn+ssh://quietust@svn.code.sf.net/p/nintendulator/code/nintendulator/trunk/src/c_s_snescont.cpp $
 * $Id: c_s_snescont.cpp 1329 2016-09-21 03:22:29Z quietust $
 */
