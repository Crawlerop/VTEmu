 ...
 *
 * $URL: svn+ssh://quietust@svn.code.sf.net/p/nintendulator/code/nintendulator/trunk/src/CPU.h $
 * $Id: CPU.h 1349 2017-06-21 02:32:25Z quietust $
 */
...
class CPU_RP2A03_PocketNES: public CPU_RP2A03 {
protected:
	uint8_t	GetOpcode (void) override;
public:
	CPU_RP2A03_PocketNES (uint8_t*);
	CPU_RP2A03_PocketNES (int, int, uint8_t*);
};
