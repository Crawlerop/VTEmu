/* NintendulatorNRS - Win32 NES emulator written in C++
 * Copyright (C) 2017-2019 NewRisingSun
 *
 * based on Nintendulator
...
LRESULT CALLBACK	WndProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	// UM6578 keyboard and mouse
	if (RI.ConsoleType ==CONSOLE_UM6578 && running && APU::APU[0]) switch(message) {
		case WM_KEYDOWN:
		case WM_KEYUP:
		case WM_MOUSEMOVE:
			dynamic_cast<APU::APU_UM6578*>(APU::APU[0])->handleWindowMessage(message, wParam, lParam);
			break;
	}
	...
	case WM_COMMAND:
		...
		case ID_FILE_OPEN:
			...
			ofn.hInstance = hInst;
			ofn.lpstrFilter =	_T("All supported files (*.NES, *.UNIF, *.UNF, *.FDS, *.FQD, *.NSF, *.WXN, *.BIN, *.FFE, *.SMC, *.RAW, *.A)\0")
		...
		case ID_SOUND_ENABLED:
			...
			Settings::ApplySettingsToMenu();
			break;
		case ID_SOUND_VTXXAPU1:			
			Settings::VTxx_APU1 = !Settings::VTxx_APU1;
			Sound::VTxx_Primary_APU = Settings::VTxx_APU1;
			Settings::ApplySettingsToMenu();
			break;
		case ID_SOUND_VTXXAPU2:
			Settings::VTxx_APU2 = !Settings::VTxx_APU2;
			Sound::VTxx_Secondary_APU = Settings::VTxx_APU2;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU1_CH1:
			Settings::APU1_CH1 = !Settings::APU1_CH1;
			Sound::APU1_Channel1 = Settings::APU1_CH1;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU1_CH2:
			Settings::APU1_CH2 = !Settings::APU1_CH2;
			Sound::APU1_Channel2 = Settings::APU1_CH2;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU1_CH3:
			Settings::APU1_CH3 = !Settings::APU1_CH3;
			Sound::APU1_Channel3 = Settings::APU1_CH3;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU1_CH4:
			Settings::APU1_CH4 = !Settings::APU1_CH4;
			Sound::APU1_Channel4 = Settings::APU1_CH4;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU1_CH5:
			Settings::APU1_CH5 = !Settings::APU1_CH5;
			Sound::APU1_Channel5 = Settings::APU1_CH5;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU2_CH1:
			Settings::APU2_CH1 = !Settings::APU2_CH1;
			Sound::APU2_Channel1 = Settings::APU2_CH1;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU2_CH2:
			Settings::APU2_CH2 = !Settings::APU2_CH2;
			Sound::APU2_Channel2 = Settings::APU2_CH2;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU2_CH3:
			Settings::APU2_CH3 = !Settings::APU2_CH3;
			Sound::APU2_Channel3 = Settings::APU2_CH3;
			Settings::ApplySettingsToMenu();
			break;
		case ID_APU2_CH4:
			Settings::APU2_CH4 = !Settings::APU2_CH4;
		...
		case ID_EXPAUDIO_ORIG:
			Settings::ExpansionAudioVolume =75;
			Settings::ApplySettingsToMenu();
			break;
