 ...
 *
 * $URL: svn+ssh://quietust@svn.code.sf.net/p/nintendulator/code/mappers/trunk/src/interface.h $
 * $Id: interface.h 1350 2017-06-21 02:34:24Z quietust $
 */
...
#define INPUT_CRAZY_CLIMBER	0x1C
